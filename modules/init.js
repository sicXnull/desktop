    ...
    if (msg === 'Request timed out') {
      ...
      if( !updatesFailedMessage )	{
	      ...
	      electron.dialog.showMessageBox({
	        ...
	        message: 'The app cannot connect to the server to check for updates. POSQ app REQUIRES internet to be used, please make sure you are connected, how would you like to continue?'
	      }, (response) => {
	        if (response === 0) {
	          electron.app.quit();
	        } else if(response === 1) {
